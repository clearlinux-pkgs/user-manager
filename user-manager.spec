...
Source0  : https://download.kde.org/stable/plasma/5.16.1/user-manager-5.16.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.1/user-manager-5.16.1.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1560881624
mkdir -p clr-build
pushd clr-build
