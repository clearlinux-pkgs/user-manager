...
Source0  : https://download.kde.org/stable/plasma/5.15.3/user-manager-5.15.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.3/user-manager-5.15.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1552414744
mkdir -p clr-build
pushd clr-build
